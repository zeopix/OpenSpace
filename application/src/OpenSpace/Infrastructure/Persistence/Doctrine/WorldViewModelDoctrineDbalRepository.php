...
class WorldViewModelDoctrineDbalRepository implements TaskViewModelRepositoryInterface
{
     ...
     */
    public function __construct(Connection $connection, $tableName = 'world_views')
    {
    ...
    public function createTable()
    {
        ...
        $table->addColumn('galaxy', 'string', array('length' => 255, 'nullable' => false));
        $table->addColumn('system', 'string', array('length' => 255, 'nullable' => false));
        $table->addColumn('planet', 'string', array('length' => 255, 'nullable' => false));
        $table->addColumn('user', 'string', array('length' => 255, 'nullable' => false));
